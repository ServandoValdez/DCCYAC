...
public class consultaActualiza extends javax.swing.JFrame {
    ...
    private void tablaConsultaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaConsultaMouseClicked
        Cliente cl = seleccionado();
        actualizarCliente c = new actualizarCliente(cl);
        c.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(consultaActualiza.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new consultaActualiza().setVisible(true);
            }
        });
    }
